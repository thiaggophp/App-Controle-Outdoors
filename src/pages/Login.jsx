    ...
    <div style={{width:"100%",maxWidth:380}}>
      ...
      {mode==="login"&&<>
        ...
        <div style={{display:"flex",justifyContent:"space-between",marginTop:18}}>
          ...
          <button onClick={()=>{setMode("signup");setMsg(null)}} style={{background:"none",border:"none",color:"#0ea5e9",fontSize:13,cursor:"pointer"}}>Solicitar Acesso</button>
        </div>
      </>}
